    ...
    <div className="bg-white">
      ...
      <section className="py-16 md:py-24 px-4 md:px-8 bg-slate-50 relative overflow-hidden text-center">
        ...
        <div className="max-w-5xl mx-auto space-y-10 relative z-10 text-center">
          ...
          <h2 className="text-3xl md:text-7xl font-extrabold text-primary tracking-tighter uppercase italic leading-tight">
            Transparency <span className="text-secondary">Builds Trust</span>
          </h2>
          <div className="p-6 md:p-16 bg-white rounded-[2.5rem] md:rounded-[4rem] border border-slate-100 shadow-2xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-12">
            {filteredImages.map((item, index) => (
              <div
                ...
                className="group relative h-[300px] md:h-[400px] rounded-[2rem] md:rounded-[3rem] overflow-hidden cursor-pointer bg-slate-100 animate-fade-in-up"
              ...
              >
                ...
                {/* Minimal Label when not hovered - visible on mobile usually if hover isn't active */}
