...
const bannerSlides = [
  {
    ...
    subtitle: "Healing Escape Global – Your Data Security is Our Commitment",
...
const PrivacyPolicy = () => {
  return (
    <div className="bg-white min-h-screen">
      ...
      {/* 2. Content Section */}
      <section id="policy-content" className="py-16 md:py-24 px-4 md:px-8">
        <div className="max-w-4xl mx-auto space-y-16">
          <div className="space-y-6 text-slate-600 leading-relaxed">
            <p className="text-lg font-medium">
              At Healing Escape Global (“we”, “our”, “us”), we are committed to
