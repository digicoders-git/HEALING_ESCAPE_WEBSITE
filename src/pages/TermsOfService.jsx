...
const bannerSlides = [
  {
    ...
    subtitle: "Healing Escape Global – Transparent Legal Agreement",
        ...
        <div className="max-w-4xl mx-auto space-y-16">
          <div className="space-y-6 text-slate-600 leading-relaxed text-center">
            <p className="text-lg font-medium italic">
              "These Terms of Service govern your use of the Healing Escape
            ...
            <div className="md:col-span-12 space-y-8">
              ...
              <div className="bg-slate-50 p-8 md:p-12 rounded-[2.5rem] border border-slate-100 shadow-inner relative overflow-hidden">
                <p className="text-slate-600 font-medium mb-8">
                  Healing Escape Global is a medical tourism facilitation and
