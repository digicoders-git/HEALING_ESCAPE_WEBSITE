...
const resources = {
  en: {
    translation: {
      ...
      "hero_title": "Connecting the World to India’s Healthcare Excellence",
      ...
      "get_free_consultation": "Get Free Medical Consultation",
  ...
  ar: {
    translation: {
      ...
      "hero_title": "ربط العالم بتميز الرعاية الصحية في الهند",
  ...
  fr: {
    translation: {
      ...
      "hero_title": "Relier le monde à l'excellence des soins de santé en Inde",
