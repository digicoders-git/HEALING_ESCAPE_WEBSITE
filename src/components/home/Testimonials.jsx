...
const testimonialsData = [
  {
    ...
    text: "The medical care I received in India through Healing Escape was exceptional. From the moment I arrived, I felt supported and cared for. The doctors were highly professional and the hospital facilities were world-class.",
    rating: 5,
  },
  {
    name: "Mohammad Al-Fayed",
    role: "Patient from UAE",
    image:
      "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?auto=format&fit=crop&q=80&w=300",
    text: "I was looking for specialized cardiac treatment and Healing Escape helped me find the best super-specialists in Lucknow. The cost was a fraction of what I would have paid elsewhere, and the service was premium.",
    rating: 5,
  },
  {
    name: "Grace Amadi",
    ...
    text: "Everything was perfectly coordinated—from my medical visa to the post-surgery follow-up. The team made a complex journey very simple. I am now back home and fully recovered. Highly recommend!",
    rating: 5,
  },
];
    ...
    <section className="py-12 bg-white overflow-hidden">
      ...
      <style>{`
        ...
        .swiper-pagination-bullet-active {
          background: #1db64c !important; /* Secondary color */
        }
      `}</style>
    </section>
  );
